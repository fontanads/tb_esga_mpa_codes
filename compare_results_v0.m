...
user_SER_BER_FER= [1 0 0]; % ou exclusivo, selecionar apenas uma posição
...
% ---------------- Result 1 ---------------- %
result(1).file = '[ZenBook-S-UX391UA]_J6_K4_M4_q4_N2_LDPC_n128_Rx_Nr1_EbN0dB_0_to_22_MinErr_50_To3_Tm1_5_Tm2_1_100r_0_[23-01-2020][18-36-01]_Temp.mat';
...
% ---------------- Result 2 ---------------- %
result(2).file = '[ZenBook-S-UX391UA]_J6_K4_M4_q4_N2_LDPC_n128_Rx_Nr2_EbN0dB_0_to_22_MinErr_50_To3_Tm1_5_Tm2_1_100r_0_[23-01-2020][19-30-14]_Temp.mat';
