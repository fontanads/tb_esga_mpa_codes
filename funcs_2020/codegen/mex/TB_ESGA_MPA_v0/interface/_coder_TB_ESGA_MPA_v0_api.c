/*
 * _coder_TB_ESGA_MPA_v0_api.c
 *
 * Code generation for function '_coder_TB_ESGA_MPA_v0_api'
 *
 */
...
static emlrtRTEInfo vd_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  "_coder_TB_ESGA_MPA_v0_api",         /* fName */
  ""                                   /* pName */
};
...
void TB_ESGA_MPA_v0_api(const mxArray * const prhs[12], int32_T nlhs, const
  mxArray *plhs[2])
{
  ...
  TB_ESGA_MPA_v0(&st, y_all, F, F_int, C_data, C_size, *C_perms_data,
                 C_perms_size, Aq_data, Aq_size, *codewords_binary_labels_data,
                 codewords_binary_labels_size, H, Tm, r_th, a_priori_beliefs,
                 varnoise, soft_bits, hard_symbols);
...
/* End of code generation (_coder_TB_ESGA_MPA_v0_api.c) */
