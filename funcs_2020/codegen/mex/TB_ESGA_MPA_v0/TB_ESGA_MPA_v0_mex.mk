...
include TB_ESGA_MPA_v0_mex.mki


SRC_FILES =  \
	TB_ESGA_MPA_v0_data.c \
	TB_ESGA_MPA_v0_initialize.c \
	...
	log.c \
	mod.c \
	_coder_TB_ESGA_MPA_v0_info.c \
	_coder_TB_ESGA_MPA_v0_api.c \
	_coder_TB_ESGA_MPA_v0_mex.c \
	TB_ESGA_MPA_v0_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = TB_ESGA_MPA_v0_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\TB_ESGA_MPA_v0"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\TB_ESGA_MPA_v0/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
