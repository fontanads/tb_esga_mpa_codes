...
MAKEFILE = uplink_SCMA_mex.mk

include uplink_SCMA_mex.mki
...
MEX_FILE_NAME_WO_EXT = uplink_SCMA_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\uplink_SCMA"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\uplink_SCMA/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
