 ...
 * uplink_SCMA.c
 *
 * Code generation for function 'uplink_SCMA'
 *
 */
...
static emlrtRSInfo emlrtRSI = { 19,    /* lineNo */
  "uplink_SCMA",                       /* fcnName */
  "C:\\Users\\Bruno Fontana\\Documents\\MATLAB\\SCMA_2020_TB_ESGA_MPA\\funcs_2020\\uplink_SCMA.m"/* pathName */
};
...
static emlrtRTEInfo emlrtRTEI = { 7,   /* lineNo */
  30,                                  /* colNo */
  "uplink_SCMA",                       /* fName */
  "C:\\Users\\Bruno Fontana\\Documents\\MATLAB\\SCMA_2020_TB_ESGA_MPA\\funcs_2020\\uplink_SCMA.m"/* pName */
};
...
void uplink_SCMA(const emlrtStack *sp, real_T J, real_T K, real_T N, real_T Ns,
                 real_T Nr, const emxArray_real_T *F, const creal_T C_data[],
                 const int32_T C_size[2], const emxArray_real_T *all_symbols,
                 const emxArray_creal_T *H, emxArray_creal_T *y,
                 emxArray_creal_T *X, emxArray_creal_T *SCMA_Symbols)
{
  int32_T ncolx;
  int32_T i1;
  int32_T b_J[3];
  ...
  /*    H: K x J  matrix of fading coefficients */
  if (!(J >= 0.0)) {
...
/* End of code generation (uplink_SCMA.c) */
