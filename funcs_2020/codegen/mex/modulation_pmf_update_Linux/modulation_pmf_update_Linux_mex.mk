...
MAKEFILE = modulation_pmf_update_Linux_mex.mk

include modulation_pmf_update_Linux_mex.mki


SRC_FILES =  \
	modulation_pmf_update_Linux_data.c \
	modulation_pmf_update_Linux_initialize.c \
	modulation_pmf_update_Linux_terminate.c \
	modulation_pmf_update_Linux.c \
	error.c \
	sum.c \
	_coder_modulation_pmf_update_Linux_info.c \
	_coder_modulation_pmf_update_Linux_api.c \
	_coder_modulation_pmf_update_Linux_mex.c \
	modulation_pmf_update_Linux_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = modulation_pmf_update_Linux_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/modulation_pmf_update_Linux"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/modulation_pmf_update_Linux/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/modulation_pmf_update_Linux/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/modulation_pmf_update_Linux/%.cu
	$(CC) $(CCFLAGS) "$<"
