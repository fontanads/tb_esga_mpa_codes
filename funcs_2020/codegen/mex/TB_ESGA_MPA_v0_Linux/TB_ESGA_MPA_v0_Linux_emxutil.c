/*
 * TB_ESGA_MPA_v0_Linux_emxutil.c
 *
 * Code generation for function 'TB_ESGA_MPA_v0_Linux_emxutil'
 *
 */
...
void f_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_5 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_creal_T1(sp, &pStruct->contents, 3, srcLocation, doPush);
}

void g_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_6 *
  pStruct)
{
  emxFree_real_T(sp, &pStruct->contents);
}

void g_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_6 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->contents, 2, srcLocation, doPush);
}

void h_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_7 *
  pStruct)
{
  emxFree_real_T(sp, &pStruct->contents);
}

void h_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_7 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T1(sp, &pStruct->contents, 3, srcLocation, doPush);
}

/* End of code generation (TB_ESGA_MPA_v0_Linux_emxutil.c) */
