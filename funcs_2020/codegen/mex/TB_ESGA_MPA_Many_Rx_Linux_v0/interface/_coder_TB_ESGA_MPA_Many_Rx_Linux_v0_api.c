 ...
 *
 * Code generation for function '_coder_TB_ESGA_MPA_Many_Rx_Linux_v0_api'
 *
 */
...
static emlrtRTEInfo nd_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  "_coder_TB_ESGA_MPA_Many_Rx_Linux_v0_api",/* fName */
  ""                                   /* pName */
};
...
static void bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  static const int32_T dims[2] = { 200, 64 };
...
void TB_ESGA_MPA_Many_Rx_Linux_v0_api(const mxArray * const prhs[12], int32_T
  nlhs, const mxArray *plhs[2])
{
  ...
  TB_ESGA_MPA_Many_Rx_Linux_v0(&st, y_all, F, F_int, C_data, C_size,
    *C_perms_data, C_perms_size, Aq_data, Aq_size, *codewords_binary_labels_data,
...
/* End of code generation (_coder_TB_ESGA_MPA_Many_Rx_Linux_v0_api.c) */
