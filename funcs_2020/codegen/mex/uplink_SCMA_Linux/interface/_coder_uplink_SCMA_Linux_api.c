...
static emlrtRTEInfo p_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_uplink_SCMA_Linux_api",      /* fName */
  ""                                   /* pName */
};
...
void uplink_SCMA_Linux_api(const mxArray * const prhs[9], int32_T nlhs, const
  mxArray *plhs[3])
{
  emxArray_real_T *F;
  ...
  uplink_SCMA_Linux(&st, J, K, N, Ns, Nr, F, C_data, C_size, all_symbols, H, y,
                    X, SCMA_Symbols);
...
/* End of code generation (_coder_uplink_SCMA_Linux_api.c) */
