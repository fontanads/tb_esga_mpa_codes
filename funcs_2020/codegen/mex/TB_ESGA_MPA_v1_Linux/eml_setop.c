...
static emlrtRSInfo sb_emlrtRSI = { 225,/* lineNo */
  "eml_setop",                         /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pathName */
};

static emlrtRSInfo hd_emlrtRSI = { 228,/* lineNo */
  "eml_setop",                         /* fcnName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pathName */
};
...
static emlrtRTEInfo cc_emlrtRTEI = { 434,/* lineNo */
  9,                                   /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};

static emlrtRTEInfo dc_emlrtRTEI = { 398,/* lineNo */
  14,                                  /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};

static emlrtRTEInfo ec_emlrtRTEI = { 398,/* lineNo */
  9,                                   /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};

static emlrtRTEInfo uc_emlrtRTEI = { 409,/* lineNo */
  18,                                  /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};
...
static emlrtRTEInfo pe_emlrtRTEI = { 392,/* lineNo */
  5,                                   /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};

static emlrtRTEInfo qe_emlrtRTEI = { 430,/* lineNo */
  5,                                   /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};

static emlrtRTEInfo ve_emlrtRTEI = { 403,/* lineNo */
  9,                                   /* colNo */
  "eml_setop",                         /* fName */
  "/usr/local/MATLAB/R2018a/toolbox/eml/lib/matlab/ops/private/eml_setop.m"/* pName */
};
                  ...
                  emxArray_int32_T *ib)
{
  ...
  c->size[0] = 1;
  c->size[1] = ncmax;
  emxEnsureCapacity_real_T(sp, c, ialast, &bc_emlrtRTEI);
  ialast = ia->size[0];
  ia->size[0] = ncmax;
  emxEnsureCapacity_int32_T1(sp, ia, ialast, &bc_emlrtRTEI);
  ialast = ib->size[0];
  ib->size[0] = ncmax;
  emxEnsureCapacity_int32_T1(sp, ib, ialast, &bc_emlrtRTEI);
  if (!issorted(a)) {
    st.site = &sb_emlrtRSI;
    b_error(&st);
  }
  ...
  emxInit_int32_T(sp, &b_ia, 1, &dc_emlrtRTEI, true);
  if (ncmax > 0) {
    if (!(nc <= ncmax)) {
    ...
    ialast = b_ia->size[0];
    b_ia->size[0] = iafirst;
    emxEnsureCapacity_int32_T1(sp, b_ia, ialast, &dc_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T1(sp, ia, ialast, &ec_emlrtRTEI);
    iafirst = b_ia->size[0];
    for (ialast = 0; ialast < iafirst; ialast++) {
    ...
    ialast = b_ia->size[0];
    b_ia->size[0] = iafirst;
    emxEnsureCapacity_int32_T1(sp, b_ia, ialast, &uc_emlrtRTEI);
    for (ialast = 0; ialast < iafirst; ialast++) {
    ...
    emxEnsureCapacity_int32_T1(sp, ib, ialast, &vc_emlrtRTEI);
    iafirst = b_ia->size[0];
    for (ialast = 0; ialast < iafirst; ialast++) {
  ...
  if (ncmax > 0) {
    if (!(nc <= ncmax)) {
      emlrtErrorWithMessageIdR2018a(sp, &qe_emlrtRTEI,
        "Coder:builtins:AssertionFailed", "Coder:builtins:AssertionFailed", 0);
    }
    ...
    emxEnsureCapacity_real_T(sp, c, ialast, &cc_emlrtRTEI);
  }
                  ...
                  int32_T ib_size[1])
{
  ...
  emxEnsureCapacity_real_T(sp, c, iblast, &bc_emlrtRTEI);
  iblast = ia->size[0];
  ia->size[0] = a->size[1];
  ...
  if (a->size[1] > 0) {
    ...
    iblast = b_ia->size[0];
    b_ia->size[0] = iafirst;
    emxEnsureCapacity_int32_T1(sp, b_ia, iblast, &dc_emlrtRTEI);
    ...
    iblast = ia->size[0];
    ia->size[0] = b_ia->size[0];
    emxEnsureCapacity_int32_T1(sp, ia, iblast, &ec_emlrtRTEI);
    iafirst = b_ia->size[0];
    for (iblast = 0; iblast < iafirst; iblast++) {
    ...
    emxEnsureCapacity_real_T(sp, c, iblast, &cc_emlrtRTEI);
  }
