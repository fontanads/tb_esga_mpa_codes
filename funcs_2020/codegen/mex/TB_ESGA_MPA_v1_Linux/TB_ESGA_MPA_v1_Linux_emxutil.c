/*
 * TB_ESGA_MPA_v1_Linux_emxutil.c
 *
 * Code generation for function 'TB_ESGA_MPA_v1_Linux_emxutil'
 *
 */
...
static void emxInitStruct_struct0_T(struct0_T *pStruct)
{
  pStruct->best_subset.size[0] = 0;
  pStruct->best_subset.size[1] = 0;
}

void c_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref
  *pStruct)
{
  emxFree_boolean_T(sp, &pStruct->contents);
}

void c_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref
  *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_boolean_T(sp, &pStruct->contents, 2, srcLocation, doPush);
}

void d_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_1 *
  pStruct)
{
  emxFree_real_T(sp, &pStruct->contents);
}

void d_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_1 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->contents, 2, srcLocation, doPush);
}

void e_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_3 *
  pStruct)
{
  emxFree_creal_T(sp, &pStruct->contents);
}

void e_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_3 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_creal_T(sp, &pStruct->contents, 2, srcLocation, doPush);
}
...
void emxEnsureCapacity_creal_T2(const emlrtStack *sp, emxArray_creal_T *emxArray,
  int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
...
void emxEnsureCapacity_int8_T1(const emlrtStack *sp, emxArray_int8_T *emxArray,
  int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
...
void emxInit_creal_T2(const emlrtStack *sp, emxArray_creal_T **pEmxArray,
                      int32_T numDimensions, const emlrtRTEInfo *srcLocation,
                      boolean_T doPush)
{
  emxArray_creal_T *emxArray;
...
void emxInit_int8_T1(const emlrtStack *sp, emxArray_int8_T **pEmxArray, int32_T
                     numDimensions, const emlrtRTEInfo *srcLocation, boolean_T
                     doPush)
{
  emxArray_int8_T *emxArray;
...
void f_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_5 *
  pStruct)
{
  emxFree_real_T(sp, &pStruct->contents);
}

void f_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_5 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->contents, 2, srcLocation, doPush);
}

void g_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_2 *
  pStruct)
{
  emxFree_creal_T(sp, &pStruct->contents);
}

void g_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_2 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_creal_T1(sp, &pStruct->contents, 1, srcLocation, doPush);
}

void h_emxFreeStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_6 *
  pStruct)
{
  emxFree_real_T(sp, &pStruct->contents);
}

void h_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_6 *
  pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T1(sp, &pStruct->contents, 3, srcLocation, doPush);
}

/* End of code generation (TB_ESGA_MPA_v1_Linux_emxutil.c) */
