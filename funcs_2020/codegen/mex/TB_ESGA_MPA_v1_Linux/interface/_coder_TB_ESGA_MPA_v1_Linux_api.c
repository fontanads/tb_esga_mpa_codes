/*
 * _coder_TB_ESGA_MPA_v1_Linux_api.c
 *
 * Code generation for function '_coder_TB_ESGA_MPA_v1_Linux_api'
 *
 */
...
static emlrtRTEInfo yd_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  "_coder_TB_ESGA_MPA_v1_Linux_api",   /* fName */
  ""                                   /* pName */
};
...
static void v_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_creal_T *ret)
{
  static const int32_T dims[3] = { 40, 80, 512 };
...
void TB_ESGA_MPA_v1_Linux_api(const mxArray * const prhs[13], int32_T nlhs,
  const mxArray *plhs[2])
{
  ...
  TB_ESGA_MPA_v1_Linux(&st, y_all, *F_data, F_size, *F_int_data, F_int_size,
                       C_data, C_size, *C_perms_data, C_perms_size, Aq_data,
                       Aq_size, *codewords_binary_labels_data,
                       codewords_binary_labels_size, H, Tm, r_th,
                       a_priori_beliefs, varnoise, edge_subset, soft_bits,
                       hard_symbols);
...
/* End of code generation (_coder_TB_ESGA_MPA_v1_Linux_api.c) */
