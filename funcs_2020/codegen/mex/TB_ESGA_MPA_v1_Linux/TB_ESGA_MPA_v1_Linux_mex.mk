...
MAKEFILE = TB_ESGA_MPA_v1_Linux_mex.mk

include TB_ESGA_MPA_v1_Linux_mex.mki


SRC_FILES =  \
	TB_ESGA_MPA_v1_Linux_data.c \
	TB_ESGA_MPA_v1_Linux_initialize.c \
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/TB_ESGA_MPA_v1_Linux"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/TB_ESGA_MPA_v1_Linux/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/TB_ESGA_MPA_v1_Linux/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/TB_ESGA_MPA_v1_Linux/%.cu
	$(CC) $(CCFLAGS) "$<"
