...
static emlrtRSInfo mc_emlrtRSI = { 228,/* lineNo */
  "eml_setop",                         /* fcnName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pathName */
};

static emlrtRTEInfo rb_emlrtRTEI = { 134,/* lineNo */
  22,                                  /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo sb_emlrtRTEI = { 434,/* lineNo */
  9,                                   /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo tb_emlrtRTEI = { 398,/* lineNo */
  14,                                  /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo ub_emlrtRTEI = { 398,/* lineNo */
  9,                                   /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo ic_emlrtRTEI = { 409,/* lineNo */
  18,                                  /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo jc_emlrtRTEI = { 409,/* lineNo */
  13,                                  /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo ae_emlrtRTEI = { 392,/* lineNo */
  5,                                   /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo be_emlrtRTEI = { 430,/* lineNo */
  5,                                   /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};

static emlrtRTEInfo de_emlrtRTEI = { 403,/* lineNo */
  9,                                   /* colNo */
  "eml_setop",                         /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\ops\\private\\eml_setop.m"/* pName */
};
                  ...
                  emxArray_int32_T *ib)
{
  ...
  c->size[0] = 1;
  c->size[1] = ncmax;
  emxEnsureCapacity_real_T(sp, c, ialast, &rb_emlrtRTEI);
  ialast = ia->size[0];
  ia->size[0] = ncmax;
  emxEnsureCapacity_int32_T1(sp, ia, ialast, &rb_emlrtRTEI);
  ialast = ib->size[0];
  ib->size[0] = ncmax;
  emxEnsureCapacity_int32_T1(sp, ib, ialast, &rb_emlrtRTEI);
  if (!issorted(a)) {
    st.site = &mb_emlrtRSI;
    b_error(&st);
  }
  ...
  emxInit_int32_T(sp, &b_ia, 1, &tb_emlrtRTEI, true);
  if (ncmax > 0) {
    if (!(nc <= ncmax)) {
    ...
    ialast = b_ia->size[0];
    b_ia->size[0] = iafirst;
    emxEnsureCapacity_int32_T1(sp, b_ia, ialast, &tb_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T1(sp, ia, ialast, &ub_emlrtRTEI);
    iafirst = b_ia->size[0];
    for (ialast = 0; ialast < iafirst; ialast++) {
    ...
    ialast = b_ia->size[0];
    b_ia->size[0] = iafirst;
    emxEnsureCapacity_int32_T1(sp, b_ia, ialast, &ic_emlrtRTEI);
    for (ialast = 0; ialast < iafirst; ialast++) {
    ...
    emxEnsureCapacity_int32_T1(sp, ib, ialast, &jc_emlrtRTEI);
    iafirst = b_ia->size[0];
    for (ialast = 0; ialast < iafirst; ialast++) {
  ...
  if (ncmax > 0) {
    ...
    emxEnsureCapacity_real_T(sp, c, ialast, &sb_emlrtRTEI);
  }
                  ...
                  int32_T ib_size[1])
{
  ...
  emxEnsureCapacity_real_T(sp, c, iblast, &rb_emlrtRTEI);
  iblast = ia->size[0];
  ia->size[0] = a->size[1];
  emxEnsureCapacity_int32_T1(sp, ia, iblast, &rb_emlrtRTEI);
  ib_size[0] = 0;
  if (!issorted(a)) {
    st.site = &mb_emlrtRSI;
    b_error(&st);
  ...
  if (a->size[1] > 0) {
    ...
    iblast = b_ia->size[0];
    b_ia->size[0] = iafirst;
    emxEnsureCapacity_int32_T1(sp, b_ia, iblast, &tb_emlrtRTEI);
    ...
    iblast = ia->size[0];
    ia->size[0] = b_ia->size[0];
    emxEnsureCapacity_int32_T1(sp, ia, iblast, &ub_emlrtRTEI);
    iafirst = b_ia->size[0];
    for (iblast = 0; iblast < iafirst; iblast++) {
    ...
    emxEnsureCapacity_real_T(sp, c, iblast, &sb_emlrtRTEI);
  }
