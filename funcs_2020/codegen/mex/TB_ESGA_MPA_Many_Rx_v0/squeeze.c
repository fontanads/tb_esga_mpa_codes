...
static emlrtRTEInfo hc_emlrtRTEI = { 31,/* lineNo */
  1,                                   /* colNo */
  "squeeze",                           /* fName */
  "C:\\Program Files\\MATLAB\\R2018a\\toolbox\\eml\\lib\\matlab\\elmat\\squeeze.m"/* pName */
};
               ...
               *b)
{
  ...
  b->size[0] = sqsz_idx_0;
  b->size[1] = 1;
  emxEnsureCapacity_real_T(&st, b, k, &hc_emlrtRTEI);
             ...
             *b)
{
  ...
  b->size[0] = 1;
  b->size[1] = a->size[1];
  emxEnsureCapacity_creal_T(&st, b, nx, &hc_emlrtRTEI);
  n = a->size[1];
  for (nx = 0; nx < n; nx++) {
    b->data[nx] = a->data[nx];
  }
