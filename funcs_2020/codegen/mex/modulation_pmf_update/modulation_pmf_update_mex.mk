...
MAKEFILE = modulation_pmf_update_mex.mk

include modulation_pmf_update_mex.mki


SRC_FILES =  \
	modulation_pmf_update_data.c \
...
MEX_FILE_NAME_WO_EXT = modulation_pmf_update_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\modulation_pmf_update"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\modulation_pmf_update/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
