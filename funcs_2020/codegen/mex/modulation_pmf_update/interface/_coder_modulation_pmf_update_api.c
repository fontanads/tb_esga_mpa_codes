/*
 * _coder_modulation_pmf_update_api.c
 *
 * Code generation for function '_coder_modulation_pmf_update_api'
 *
 */
...
static emlrtRTEInfo k_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_modulation_pmf_update_api",  /* fName */
  ""                                   /* pName */
};
  ...
  int32_T y_size[2])
{
  ...
  d_emlrt_marshallIn(sp, emlrtAlias(codewords_binary_labels), &thisId, &r1,
                     y_size);
  *y_data = r1;
...
{
  boolean_T *r2;
  f_emlrt_marshallIn(sp, emlrtAlias(u), parentId, &r2, y_size);
  *y_data = r2;
  emlrtDestroyArray(&u);
}
...
static void e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  static const int32_T dims[3] = { 200, 64, 512 };
...
void modulation_pmf_update_api(const mxArray * const prhs[2], int32_T nlhs,
  const mxArray *plhs[1])
{
  ...
  emxInit_real_T1(&st, &soft_bits_MPA_input, 3, &k_emlrtRTEI, true);
  emxInit_real_T1(&st, &a_priori_probabilities, 3, &k_emlrtRTEI, true);
  ...
  modulation_pmf_update(&st, soft_bits_MPA_input, *codewords_binary_labels_data,
                        codewords_binary_labels_size, a_priori_probabilities);
...
/* End of code generation (_coder_modulation_pmf_update_api.c) */
